...
public struct AutoPresetsSettings: Codable, Equatable {
    ...
    /// Get the preset ID for an activity type
    public func presetId(for activity: AutoPresetsActivityType) -> String? {
        activityPresets[activity.rawValue]
    }

    /// Set the preset ID for an activity type
    public mutating func setPresetId(_ presetId: String?, for activity: AutoPresetsActivityType) {
