        ...
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                HStack(spacing: 4) {
                    ...
                    if let preset = coordinator.availablePresets().first(where: { $0.id == location.presetId}) {
...
struct AutoPresets_GeofenceEditView: View {
    ...
    init(location: AutoPresetsGeofenceLocation?, availablePresets: [TemporaryPreset]) {
