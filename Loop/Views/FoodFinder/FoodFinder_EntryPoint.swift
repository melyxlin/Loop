...
struct FoodFinder_EntryPoint: View {
    ...
    var defaultAbsorptionTimes: FoodTypeRow.DefaultAbsorptionTimes
    ...
    init(
        ...
        defaultAbsorptionTimes: FoodTypeRow.DefaultAbsorptionTimes,
...
extension FoodFinder_EntryPoint {
    ...
    private func toggleQuickFavorite(for product: OpenFoodFactsProduct) {
        ...
        let new = NewFavoriteFood(
            ...
            carbsQuantity: LoopQuantity(unit: .gram, doubleValue: carbs),
            foodType: foodType,
            absorptionTime: absorptionTime
        )
